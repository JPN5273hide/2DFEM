...
int main(void){
    ...
    /*節点の座標を設定*/
    double node_coord_x[9] = {0.0,0.4,1.0,0.0,0.4,1.0,0.0,0.4,1.0};
    double node_coord_y[9] = {0.0,0.0,0.0,0.7,0.7,0.7,1.0,1.0,1.0};

    /*要素と節点の関係を設定*/
    int cnn[8][3] = {
        {0,4,3},{0,1,4},{1,2,4},{2,5,4},{3,7,6},{3,4,7},{4,8,7},{4,5,8}
    };
